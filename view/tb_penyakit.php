                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            ...
                            <a class="dropdown-item">
                                <p class="logout" <i class="ti-power-off text-primary"></i>
                                    Logout
                                </p>
                            </a>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="tb_gejala.php">Kelola Gejala</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="tb_penyakit.php">Kelola Penyakit</a>
                                </li>
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="solusi"
                                                                id="exampleInputPassword1" placeholder="Masukan solusi"
                                                                required>
                                                        </div>
